    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Edit Developer</h1>
                    <p class="text-gray-600 mt-2">Update developer information and settings</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.developers.update', $developer) }}" class="bg-white rounded-lg shadow-sm border">
            @csrf
            @method('PUT')
            <div class="p-6">
                <!-- Basic Information -->
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $developer->name) }}" required
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $developer->email) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="experience_level" name="experience_level" required
                                ...
                                <option value="junior" {{ old('experience_level', $developer->experience_level) == 'junior' ? 'selected' : '' }}>Junior (0-2 years)</option>
                                <option value="mid" {{ old('experience_level', $developer->experience_level) == 'mid' ? 'selected' : '' }}>Mid-Level (3-5 years)</option>
                                <option value="senior" {{ old('experience_level', $developer->experience_level) == 'senior' ? 'selected' : '' }}>Senior (6+ years)</option>
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="skills" name="skills" rows="3" placeholder="List key skills, technologies, and areas of expertise..."
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('skills') border-red-500 @enderror">{{ old('skills', is_array($developer->skills) ? implode(', ', $developer->skills) : $developer->skills) }}</textarea>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="tel" id="phone" name="phone" value="{{ old('phone', $developer->phone) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="country" name="country" value="{{ old('country', $developer->country) }}" placeholder="e.g., US, UK, DE"
                        ...
                        <div>
                            ...
                            <input type="text" id="city" name="city" value="{{ old('city', $developer->city) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="address" name="address" value="{{ old('address', $developer->address) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_available" value="1" {{ old('is_available', $developer->is_available) ? 'checked' : '' }}
                        ...
                        <div>
                            ...
                            <input type="text" id="working_hours" name="working_hours" value="{{ old('working_hours', is_array($developer->working_hours) ? implode(', ', $developer->working_hours) : $developer->working_hours) }}" placeholder="e.g., 9 AM - 5 PM EST"
