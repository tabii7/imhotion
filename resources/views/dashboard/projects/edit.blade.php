...
<div class="p-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            <a href="{{ route('dashboard.projects.show', $project) }}" class="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
                ...
                <p class="text-gray-300">Update project details</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8">
            <form action="{{ route('dashboard.projects.update', $project) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
