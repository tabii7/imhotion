                ...
                <div style="space-y: 16px;">
                    <div style="background: #121e2f; border: 1px solid #7fa7e1; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <div style="color: #8fa8cc; font-size: 13px; font-weight: 600; margin-bottom: 4px;">Total Purchases</div>
                                <div style="color: #ffffff; font-size: 24px; font-weight: 700;">{{ $userPurchases->count() }}</div>
                            </div>
                    ...
                    <div style="background: #121e2f; border: 1px solid #7fa7e1; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <div style="color: #8fa8cc; font-size: 13px; font-weight: 600; margin-bottom: 4px;">Total Spent</div>
                                <div style="color: #ffffff; font-size: 24px; font-weight: 700;">€{{ number_format($userPurchases->sum('amount'), 0) }}</div>
                            </div>
                            <div style="color: #7fa7e1;">
                                <svg style="width: 32px; height: 32px;" fill="currentColor" viewBox="0 0 24 24">
