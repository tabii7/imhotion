            ...
            <div class="w-full flex justify-between items-center relative">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden md:flex items-center gap-4">
                        <a href="{{ route('login') }}" class="text-white hover:text-brand-primary-200 transition-colors duration-300 text-sm font-medium">                                                                          
                            Login
                        </a>
                        <a href="{{ route('register') }}" class="bg-brand-primary text-white px-4 py-2 rounded-lg hover:bg-brand-primary/90 transition-colors duration-300 text-sm font-medium">                                    
                            Sign Up
                        </a>
                    </div>
        ...
        <footer class="bg-transparent text-white py-8 mt-16">
            <div class="max-w-6xl mx-auto px-4 text-center">
                ...
                <div class="text-sm text-pricing-subtitle">
                    © 2025 Imhotion. All rights reserved.
                </div>
            </div>
        </footer>
    </body>
