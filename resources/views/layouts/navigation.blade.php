    ...
    <div class="w-full flex justify-between items-center relative">
        ...
        <div class="absolute top-16 right-0 bg-black/95 backdrop-blur-md flex-col p-6 gap-2 z-50 min-w-64 rounded-bl-xl shadow-2xl border border-white/10" 
            ...
            <a href="{{ route('developer.dashboard') }}" 
               class="text-white hover:text-brand-primary-200 hover:bg-white/10 px-4 py-3 rounded-lg transition-all duration-300 flex items-center gap-3 {{ request()->routeIs('developer.*') ? 'bg-white/10 text-brand-primary-200' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('administrator.dashboard') }}" 
               class="text-white hover:text-brand-primary-200 hover:bg-white/10 px-4 py-3 rounded-lg transition-all duration-300 flex items-center gap-3 {{ request()->routeIs('administrator.*') ? 'bg-white/10 text-brand-primary-200' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="text-white hover:text-brand-primary-200 hover:bg-white/10 px-4 py-3 rounded-lg transition-all duration-300 flex items-center gap-3 {{ request()->routeIs('admin.*') ? 'bg-white/10 text-brand-primary-200' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
